...
client.on('ready', async () => {
 ...
 client.user.setActivity(`✮ Yükselişimizi`, { type:'WATCHING' })
...
client.on("guildMemberAdd", member => {
  ...
  moment.locale("tr")
   ...
   var rol = member.guild.roles.cache.get("793043391478628362") //Cezalı Rol İD
   var kayıtsız = member.guild.roles.cache.get("793043352534515742") //Alınacak Rol İD
...
const voiceChannel = "794629775142420481"
